...
class HtmlTestPlanBuilder extends TestPlanBuilder {
    ...
    private Map<String, List<FeatureInfo>> elements = [:]
    ...
    TestPlanBuilder appendFeature(Manual annotation, FeatureInfo feature) {
        ...
        htmlWriter.p {
            a(href: openBugJiraLink(annotation, feature), "create Bug")
        }
    ...
    private String openBugJiraLink(Manual annotation, FeatureInfo feature) {
